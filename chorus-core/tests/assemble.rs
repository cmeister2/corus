...
use chorus_core::elf::{AuxvT, FpRegs, Prpsinfo, Regs};
use chorus_core::elfcore::{CoreInputs, ThreadState};
use chorus_core::io::{Pipe, SimpleWriter};
use chorus_core::proc_parse::{finalize_mappings, mapping_buf, parse_self_maps};
use core::mem;
